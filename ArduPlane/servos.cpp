...
#endif
    SRV_Channels::set_slew_rate(func, slewrate, G_Dt);
}
...
void Plane::set_servos_flaps(void)
{
    ...
    SRV_Channels::set_slew_rate(SRV_Channel::k_flap_auto, g.flap_slewrate, G_Dt);
    SRV_Channels::set_slew_rate(SRV_Channel::k_flap, g.flap_slewrate, G_Dt);
