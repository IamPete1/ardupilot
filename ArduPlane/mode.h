...
private:
    ...
    // altitude above and distance to next_WP_loc at the moment the
    // approach-phase descent ramp starts, used to ramp the target down to
    // RTL_ALTITUDE instead of targeting it immediately
