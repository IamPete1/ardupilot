...
const AP_Param::GroupInfo QuadPlane::var_info2[] = {
    ...
    // @DisplayName: INTERP method Tailsitter minimum airspeed scaling
    // @Description: INTERP method only, below this airspeed tailsitter is controlled by copter gains, gains scaled linearly between TAILSIT_SPDMIN and TAILSIT_SPDMAX, this apply s in Q modes and during Q assist if enabled
    // @Units: m/s
    // @Range: 0 50
    // @User: Standard
    ...
    // @DisplayName: INTERP method Tailsitter maximum airspeed scaling
    // @Description: INTERP method only, above this airspeed tailsitter is controlled by plane gains, gains scaled linearly between TAILSIT_SPDMIN and TAILSIT_SPDMAX, this apply s in Q modes and during Q assist if enabled
    // @Units: m/s
    // @Range: 0 50
    // @User: Standard
    ...
    AP_GROUPINFO("TAILSIT_GSCMSK", 19, QuadPlane, tailsitter.gain_scaling_mask, 1),
