...
#define AP_RANGEFINDER_VL53L5CX_ENABLED 1
#ifndef AP_RANGEFINDER_VL53L5CX_ENABLED
#define AP_RANGEFINDER_VL53L5CX_ENABLED (AP_RANGEFINDER_BACKEND_DEFAULT_ENABLED && HAL_PROGRAM_SIZE_LIMIT_KB > 1024)
#endif