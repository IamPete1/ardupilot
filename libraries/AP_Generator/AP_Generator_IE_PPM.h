...
class AP_Generator_IE_PPM : public AP_Generator_IE_FuelCell
{
public:

    AP_Generator_IE_PPM(AP_Generator& frontend);

    AP_BattMonitor::Failsafe update_failsafes() const override;

     // get singleton instance
    static AP_Generator_IE_PPM *get_singleton(void) {
        return _singleton;
    }
    ...
    float get_PPM_voltage() { return _PPM_last.output_voltage; }
    float get_PPM_current() { return _PPM_last.output_current; }

    float get_fuel_remain_1() { return _PPM_last.fcpm_1.tank_pct * 0.01; }
    float get_fuel_remain_2() { return _PPM_last.fcpm_2.tank_pct * 0.01; }
    float get_batt_remain_1() { return _PPM_last.fcpm_1.battery_pct * 0.01; }
    float get_batt_remain_2() { return _PPM_last.fcpm_2.battery_pct * 0.01; }
...
private:
    ...
    struct PPM_ParsedValue {
        ...
        uint32_t bit_statuses;
    } _PPM_parsed, _PPM_last;
...
private:
    ...
    static AP_Generator_IE_PPM *_singleton;
