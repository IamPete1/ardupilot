...
#ifndef AP_BATTERY_INA260_ENABLED
// Only build in SITL by default
#define AP_BATTERY_INA260_ENABLED (AP_BATTERY_BACKEND_DEFAULT_ENABLED && CONFIG_HAL_BOARD == HAL_BOARD_SITL)
#endif
