...
AC_PI::AC_PI(float initial_p, float initial_i, float initial_imax)
{
    ...
    AP_Param::set_and_default(this, var_info, &kP, initial_p);
    AP_Param::set_and_default(this, var_info, &kI, initial_i);
    AP_Param::set_and_default(this, var_info, &imax, initial_imax);
}
