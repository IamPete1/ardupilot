...
bool AP_MotorsMatrix_Scripting_Dynamic::add_motor(int8_t motor_num, uint8_t testing_order)
{
    if (initialised_ok()) {
...
void AP_MotorsMatrix_Scripting_Dynamic::load_factors(factor_table &new_table)
{
    WITH_SEMAPHORE(_sem);
    had_table = true;
