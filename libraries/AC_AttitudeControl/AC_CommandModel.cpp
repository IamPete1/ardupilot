...
const AP_Param::GroupInfo AC_CommandModel::var_info[] = {
    ...
    // @Range: 1 360
    // @User: Standard
    AP_GROUPINFO("RATE", 1, AC_CommandModel, rate, 0.0),
    ...
    // @Range: -0.5 1.0
    // @User: Advanced
    AP_GROUPINFO("EXPO", 2, AC_CommandModel, expo, 0.0),
    ...
    // @User: Standard
    AP_GROUPINFO("RATE_TC", 3, AC_CommandModel, rate_tc, 0),
...
AC_CommandModel::AC_CommandModel(float initial_rate, float initial_expo, float initial_tc)
{
    ...
    AP_Param::set_and_default(this, var_info, &rate, initial_rate);
    AP_Param::set_and_default(this, var_info, &expo, initial_expo);
    AP_Param::set_and_default(this, var_info, &rate_tc, initial_tc);
}
