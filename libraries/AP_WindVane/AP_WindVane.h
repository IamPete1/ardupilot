...
private:
    ...
    LowPassFilterFloat _direction_apparent_sin_filt = LowPassFilterFloat(2.0f, 20.0f);
    LowPassFilterFloat _direction_apparent_cos_filt = LowPassFilterFloat(2.0f, 20.0f);
    LowPassFilterFloat _direction_true_sin_filt = LowPassFilterFloat(2.0f, 20.0f);
    LowPassFilterFloat _direction_true_cos_filt = LowPassFilterFloat(2.0f, 20.0f);
    LowPassFilterFloat _tack_sin_filt = LowPassFilterFloat(0.05f, 20.0f);
    LowPassFilterFloat _tack_cos_filt = LowPassFilterFloat(0.05f, 20.0f);
    ...
    LowPassFilterFloat _speed_apparent_filt = LowPassFilterFloat(2.0f, 20.0f);
    LowPassFilterFloat _speed_true_filt = LowPassFilterFloat(2.0f, 20.0f);
