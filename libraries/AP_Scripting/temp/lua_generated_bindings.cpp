...
int new_AP_HAL__OwnPtrparam_type_ptr(lua_State *L) {
    luaL_checkstack(L, 2, "Out of stack");
    void *ud = lua_newuserdata(L, sizeof(AP_HAL::OwnPtr<param_type_ptr> *));
    memset(ud, 0, sizeof(AP_HAL::OwnPtr<param_type_ptr> *));
    luaL_getmetatable(L, "AP_HAL::OwnPtr<param_type_ptr>");
    lua_setmetatable(L, -2);
    return 1;
}
...
AP_HAL::OwnPtr<param_type_ptr> ** check_AP_HAL__OwnPtrparam_type_ptr(lua_State *L, int arg) {
    void *data = luaL_checkudata(L, arg, "AP_HAL::OwnPtr<param_type_ptr>");
    return (AP_HAL::OwnPtr<param_type_ptr> **)data;
}
...
static int AP_Param_find_param(lua_State *L) {
    ...
    //AP_HAL::OwnPtr<param_type_ptr> data = std::move(ud->find_param(data_2));

    //luaL_checkstack(L, 2, "Out of stack");
    AP_HAL::OwnPtr<param_type_ptr> *data = (AP_HAL::OwnPtr<param_type_ptr> *)lua_newuserdata(L, sizeof(AP_HAL::OwnPtr<param_type_ptr>));
    //data = std::move(ud->find_param(data_2));
    *data = std::move(ud->find_param(data_2));
    //memset(ud, 0, sizeof(AP_HAL::OwnPtr<param_type_ptr>));
    luaL_getmetatable(L, "AP_HAL::OwnPtr<param_type_ptr>");
    lua_setmetatable(L, -2);
    
    //check_AP_HAL__OwnPtrparam_type_ptr(L, -1) = std::move(ud->find_param(data_2));
    return 1;
}
...
const luaL_Reg AP_Param_meta[] = {
    {"find_param", AP_Param_find_param},
...
static int AP_HAL__OwnPtrparam_type_ptr_set_and_save(lua_State *L) {
    binding_argcheck(L, 2);
    AP_HAL::OwnPtr<param_type_ptr> * ud = *check_AP_HAL__OwnPtrparam_type_ptr(L, 1);
    if (ud == NULL) {
    ...
    luaL_argcheck(L, ((raw_data_2 >= MAX(-FLT_MAX, -INFINITY)) && (raw_data_2 <= MIN(FLT_MAX, INFINITY))), 2, "argument out of range");
    const float data_2 = raw_data_2;
    const bool data = ud->get()->set_and_save(
            data_2);
...
static int AP_HAL__OwnPtrparam_type_ptr_set(lua_State *L) {
    binding_argcheck(L, 2);
    AP_HAL::OwnPtr<param_type_ptr> * ud = *check_AP_HAL__OwnPtrparam_type_ptr(L, 1);
    if (ud == NULL) {
        return luaL_error(L, "Internal error, null pointer");
...
static int AP_HAL__OwnPtrparam_type_ptr_get(lua_State *L) {
    binding_argcheck(L, 1);
    AP_HAL::OwnPtr<param_type_ptr> * ud = *check_AP_HAL__OwnPtrparam_type_ptr(L, 1);
    if (ud == NULL) {
        return luaL_error(L, "Internal error, null pointer");
...
const luaL_Reg AP_HAL__OwnPtrparam_type_ptr_meta[] = {
    {"set_and_save", AP_HAL__OwnPtrparam_type_ptr_set_and_save},
    {"set", AP_HAL__OwnPtrparam_type_ptr_set},
    {"get", AP_HAL__OwnPtrparam_type_ptr_get},
    {NULL, NULL}
};
...
const struct userdata_meta ap_object_fun[] = {
    {"AP_HAL::OwnPtrparam_type_ptr", AP_HAL__OwnPtrparam_type_ptr_meta, NULL},
...
const struct userdata {
    ...
    {"AP_HAL::OwnPtr<param_type_ptr>", new_AP_HAL__OwnPtrparam_type_ptr},
