...
static int AP_BattMonitor_get_serial_number(lua_State *L) {
    ...
    const uint8_t data_2 = static_cast<uint8_t>(raw_data_2);
    const int32_t data = ud->get_serial_number(
            data_2);
...
static int AP_BattMonitor_reset_remaining(lua_State *L) {
    ...
    const float data_3 = raw_data_3;
    const bool data = ud->reset_remaining(
            data_2,
            data_3);
...
const luaL_Reg AP_BattMonitor_meta[] = {
    {"get_serial_number", AP_BattMonitor_get_serial_number},
