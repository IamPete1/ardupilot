...
void Mode::calc_roll_pitch()
{
    ...
    // do roll and pitch calculations
    // give +- 10 deg fixed range for the time being
    ...
    if (rollin != nullptr) {
        ...
        // calculate roll angle required to bring resultant total acceleration in line with 
        // boat frame Z
        target_roll = atan2f(lat_accel, GRAVITY_MSS);
    }
