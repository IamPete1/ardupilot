...
class AutoTestQuadPlane(vehicle_test_suite.TestSuite):
    ...
    def QRTLGradualAltDescent(self):
        ...
        # entry_alt (~100m) is well above RTL_ALTITUDE (60m).  The target
        # should ease down from entry_alt towards RTL_ALTITUDE over the
        # whole return leg, rather than immediately snapping down to
        # RTL_ALTITUDE now while still ~900m short of home.
